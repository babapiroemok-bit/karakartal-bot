...
const pages = [
  {
    ...
    description: [
      ...
      '`/kick` — Kullanıcıyı at',
      '`/mute` — Kullanıcıyı sustur (dakika)',
      '`/uyari` — Uyarı ver',
      '`/uyarilar` — Uyarıları listele',
      '`/uyarisil` — Uyarı ID ile sil',
    ].join('\n'),
  },
  {
    ...
    description: [
      ...
      '`/arac-ekle` — Araç ekle *(Yetkili)*',
      '`/arac-listesi` — Araç listesi',
      '`/teslimat-olustur` — Teslimat ilanı aç',
      '`/teslimat-al` — Teslimat üstlen',
      '`/teslimat-tamamla` — Teslimatı bitir & ücret al',
      '`/aktif-teslimatlar` — Açık/aktif teslimatlar',
      '`/teslimat-gecmis` — Geçmiş teslimatların',
      '`/bakiye` — Bakiyeni gör',
      '`/siralama` — Bakiye liderlik tablosu',
    ].join('\n'),
  },
  {
    ...
    description: [
      '**🏆 Leveling**',
      '`/seviye` — Seviye & XP durumun',
      '`/liderlik` — XP liderlik tablosu',
      '',
      '**🎫 Destek**',
      '`/destek` — Ticket paneli aç',
      '`/ticket-zorla-kapat` — Ticket kanalını zorla kapat *(Yetkili)*',
      '',
      '**📢 Genel**',
      '`/duyuru` — Embed duyuru gönder *(Yetkili)*',
